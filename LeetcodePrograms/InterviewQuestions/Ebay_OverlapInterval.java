...
{[1,3], [7,8], [9,11]}
*/
public class Ebay_OverlapInterval {
    ...
    public List<Interval> findAllOverlappingSlots(List<Interval> interval1, List<Interval> interval2,int duration){
    ...
    public static void main(String[] args) {
        Ebay_OverlapInterval overlapInterval = new Ebay_OverlapInterval();
        ...
        System.out.println(overlapInterval.findAllOverlappingSlots(intervalList1,intervalList2,8));
    }
}
