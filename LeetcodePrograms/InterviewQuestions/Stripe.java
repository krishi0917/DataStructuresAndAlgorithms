...
find_best_closing_time("Y Y N N") should return 2
        Assert.assertEquals(3, find_best_closing_time("Y Y Y N N N N"));

        Assert.assertEquals(0, find_best_closing_time(""));
        Assert.assertEquals(1, find_best_closing_time("Y"));
        Assert.assertEquals(0, find_best_closing_time("N N N N"));
        Assert.assertEquals(4, find_best_closing_time("Y Y Y Y"));
        Assert.assertEquals(5, find_best_closing_time("N Y Y Y Y N N N Y N N Y Y N N N N Y Y N N Y N N N"));
        Assert.assertEquals(0, find_best_closing_time("N N N N N Y Y Y N N N N Y Y Y N N N Y N Y Y N Y N"));
        Assert.assertEquals(25, find_best_closing_time("Y Y N N N Y Y N Y Y N N N Y Y N N Y Y Y N Y N Y Y"));
...
For example, given the aggregate log:
  ...
  "BEGIN BEGIN BEGIN N N BEGIN Y Y END N N END BEGIN N N END"
                         ^           ^         ^           ^
                         |           |
                         +-----------+
                           valid log
